...
class CustomLinearPage extends StatefulWidget {
  @override
  _CustomLinearPageState createState() => _CustomLinearPageState();
}

class _CustomLinearPageState extends State<CustomLinearPage> {
