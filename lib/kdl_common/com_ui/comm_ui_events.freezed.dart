...
mixin _$CommUiEvents<T> {
  ...
  @JsonKey(ignore: true)
  $CommUiEventsCopyWith<T, CommUiEvents<T>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CommUiEventsCopyWith<T, $Res> {
  factory $CommUiEventsCopyWith(
          CommUiEvents<T> value, $Res Function(CommUiEvents<T>) then) =
      _$CommUiEventsCopyWithImpl<T, $Res>;
  $Res call({String message});
}

/// @nodoc
class _$CommUiEventsCopyWithImpl<T, $Res>
    implements $CommUiEventsCopyWith<T, $Res> {
  _$CommUiEventsCopyWithImpl(this._value, this._then);

  final CommUiEvents<T> _value;
  // ignore: unused_field
  final $Res Function(CommUiEvents<T>) _then;
...
class __$$ShowSnackBarCopyWithImpl<T, $Res>
    extends _$CommUiEventsCopyWithImpl<T, $Res>
...
class _$ShowSnackBar<T> implements ShowSnackBar<T> {
  ...
  @override
  String toString() {
    return 'CommUiEvents<$T>.showSnackBar(message: $message)';
  }
...
abstract class ShowSnackBar<T> implements CommUiEvents<T> {
